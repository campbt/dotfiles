...
let g:airline#themes#tylernord#palette = {}
...
let g:airline#themes#tylernord#palette.normal = airline#themes#generate_color_map(s:NMain, s:NRight, s:NMiddle)
...
let g:airline#themes#tylernord#palette.insert = airline#themes#generate_color_map(s:IMain, s:IRight, s:IMiddle)

let s:RMain = [s:nord1_gui, s:nord13_gui, s:nord1_term, s:nord13_term]
...
let g:airline#themes#tylernord#palette.replace = airline#themes#generate_color_map(s:RMain, s:RRight, s:RMiddle)

let s:VMain = [s:nord1_gui, s:nord15_gui, s:nord1_term, s:nord15_term]
...
let g:airline#themes#tylernord#palette.visual = airline#themes#generate_color_map(s:VMain, s:VRight, s:VMiddle)
...
let g:airline#themes#tylernord#palette.inactive = airline#themes#generate_color_map(s:IAMain, s:IARight, s:IAMiddle)
