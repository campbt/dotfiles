...
" SPECIAL: The following highlight overrides the standard Nord style because
"          ConEmu / Windows doesn't allow setting a background independent of
"          the standard 16 colors. So, the terminal background was placed in
"          0, and the original nord 0 was placed in 9
let s:nord1_term = "9" " <--- normally 0
let s:nord3_term = "8"
let s:nord5_term = "7"
let s:nord6_term = "15"
let s:nord7_term = "14"
...
" :highlight Visual cterm=NONE ctermbg=9 ctermfg=NONE guibg=Grey40
...
if g:nord_uniform_diff_background == 0
  call s:hi("DiffAdd", s:nord14_gui, s:nord0_gui, s:nord14_term, "NONE", "", "")
  call s:hi("DiffChange", s:nord13_gui, s:nord0_gui, s:nord13_term, "NONE", "", "")
  call s:hi("DiffDelete", s:nord11_gui, s:nord0_gui, s:nord11_term, "NONE", "", "")
  call s:hi("DiffText", s:nord13_gui, s:nord0_gui, s:nord13_term, "NONE", "", "")
else
  ...
  call s:hi("DiffText", s:nord13_gui, "", s:nord13_term, "", "", "")
endif
